...
function LoadData() {
    if (tasks.length < 1) {
        ...
        for (let index = 0; index < tasks.length; index++) {
            txt += "<li>" + tasks[index] + " <span onclick='RemoveTask(" + index + ")'><img style='margin-right:'2px'' src='images/delete.png' width='25'></span><span onclick='EditTask(" + index + ")'><img src='images/edit.png' width='25'></span></li>";
        }
